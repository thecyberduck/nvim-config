...
_G.packer_plugins = {
  ...
  ["gitsigns.nvim"] = {
    loaded = true,
    path = "/home/duck/.local/share/nvim/site/pack/packer/start/gitsigns.nvim",
  ...
  ["kanagawa.nvim"] = {
    loaded = true,
    path = "/home/duck/.local/share/nvim/site/pack/packer/start/kanagawa.nvim",
  ...
  tagbar = {
    loaded = true,
    path = "/home/duck/.local/share/nvim/site/pack/packer/start/tagbar",
